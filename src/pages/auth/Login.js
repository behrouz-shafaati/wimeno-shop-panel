        ...
        <HeaderStyle>
          ...
          {/* {smUp && (
            <Typography variant="body2" sx={{ mt: { md: -2 } }}>
              {translate('account.dontHaveAccount')} {''}
              <Link variant="subtitle2" component={RouterLink} to={PATH_AUTH.register}>
                {translate('account.startCreate')}
              </Link>
            </Typography>
          )} */}
        </HeaderStyle>
          ...
          <ContentStyle>
            <Stack direction="row" alignItems="center" sx={{ mb: 5 }}>
              <Box sx={{ flexGrow: 1 }}>
                ...
                <Typography sx={{ color: 'text.secondary' }}>{translate('account.loginSubTitle')}</Typography>
              </Box>
