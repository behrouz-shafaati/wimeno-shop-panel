  ...
  return (
    <TableRow hover selected={selected}>
      <TableCell sx={{ display: 'flex', alignItems: 'center' }}>
        <Link noWrap variant="subtitle2" onClick={onViewRow} sx={{ cursor: 'pointer' }}>
          {invoiceNumber}
        </Link>
      </TableCell>
      ...
      <TableCell align="right">
        <Button size="small" startIcon={<Iconify icon="eva:eye-fill" />} onClick={onViewRow}>
          {translate('invoice.view')}
        </Button>
        {/* <TableMoreMenu
          open={openMenu}
