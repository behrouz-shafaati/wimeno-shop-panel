...
export default function TicketItemAction({ handleArchive, handleDelete, handleMarkRead, handleHidden, ...other }) {
  const MAIL_ACTIONS = [
    {
      name: 'Archive',
    ...
    {
      name: 'Mark Eticket Read',
      icon: 'ic:round-mark-eticket-read',
